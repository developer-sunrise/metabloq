...
const avatar2 = require('../../assets/profilepics/face5.jpg').default
const avatar3 = require('../../assets/profilepics/face6.jpg').default
...
export const CollectablesData = [
    {
        ...
        likes:150,
        avatar:avatar1,
        name:'Spaces that inspire',
        sub_title:'Roby Williams',
    },
    {
        id:2,
        image:img2,
        likes:150,
        avatar:avatar2,
        name:'Black power cards 4x4',
        sub_title:'Adam Newman',
    },
    {
        id:3,
        image:img3,
