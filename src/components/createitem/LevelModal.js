...
function LevelModal(props) {
  let { levelModal, setLevelModal, levelModalClose,setAttributes } = props;

  const saveClick = () => {
    var newArr = inputFields.map((x) => {
      return {
        trait_type: x.name,
        value: (x.value1 / x.value2) * 100,
        type:"level"
      };
    });
    setAttributes(newArr,"level")
    setLevelModal(false);
  };
          ...
          <div className="placebid_modal-box">
            <Stack gap={3}>
              <div className=" d-flex justify-content-between align-items-center">
                <h3 className="font-weight-bold">Add Levels</h3>
                <small onClick={levelModalClose} style={{ cursor: "pointer" }}>
                  X
                </small>
              </div>
              ...
              <small>
                ...
                filtered in your collections's sidebar
              </small>
              <div className="">
                <Row>
                  <Col>Name</Col>
